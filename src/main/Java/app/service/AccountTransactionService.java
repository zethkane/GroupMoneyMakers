...
//
//    public Double depositToAccount(int accountId, Double depositAmount){
...
//    }
//
//    public Double withdrawFromAccount(int accountId, Double withdrawAmount){
//        Account account= accountRepository.getOne(accountId);
...
//
//    }
//    public Boolean transfer(int withdrawalAccountId, int depositAccountId, Double amount){
